...
const { parse, parseJson, isValid, explain, compile, injectFilter, version } = nqql;
...
const route = compile(q);
console.log('3. compile()', route.stmt_type, route.method, route.path, '\n');
