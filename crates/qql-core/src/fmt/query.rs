//! Formatting for QUERY statements and expressions.

use crate::ast::{
    ContextPair, FusionMethod, OrderDirection, Prefetch, PrefetchSource, QueryCollection,
    QueryExpr, QueryInput, QueryStmt, RecommendStrategy, SearchParams, VectorKind, VectorTarget,
    escape_string,
};
use crate::fmt::expr::{
    render_f64, render_filter, render_formula, render_name, render_payload_selector,
    render_placeholder, render_point_id, render_read_consistency, render_value,
