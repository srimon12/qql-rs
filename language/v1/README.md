...
(canonical AST schema `qql.ast/v1`). The **current language version is 1.7**.
...
| Website TS Keywords | Derived | `website/src/lib/playground/editor/qql-keywords.generated.ts` | `qql-grammar-gen check` (CI) |
...
```text
conformant: 40 valid files (298 statements), 73 invalid cases, 40 AST snapshots, 40 canonical formats
```
