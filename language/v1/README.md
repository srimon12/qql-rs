...
(canonical AST schema `qql.ast/v1`). The **current language version is 1.6**.
...
Expected result (language 1.6):

```text
conformant: 40 valid files (276 statements), 59 invalid cases, 40 AST snapshots, 40 canonical formats
```
